$(document).ready( function() {
	  ...
	  items: [
		{
		  ...
		  shortContent: '通过分解药物分子结构，以子片段作为描述符，挖掘其和药物不良反应的关系。主要负责：结构处理，数据分析和模型构建。',
		  forcePosition: 'left'
		},
		{
		  type: 'smallItem',
		...
		},
		{
		  ...
		  shortContent: '基于现有的多位点序列分型（MLST）方法，提出更快捷和方便的SNP分型方法，并简化和完善pipeline。主要负责：方法设计和优化，生成实验参考手册。',
		  forcePosition: 'left'
		},
		{
		  type: 'smallItem',
		...
		},
		{
		  ...
		  shortContent: '模拟246位氨基酸突变前后，β-微管蛋白构像的改变对αβ-微管蛋白的结合能力的影响，阐述了更稳定的αβ-微管蛋白会影响微管的动力学，促进拟南芥的生长。',
		  forcePosition: 'left'
		}
	  ]
	});
	...
	$('#timeline-2').timelineMe({
	  items: [
		...
		{
		  type: 'smallItem',
		  label: '&nbsp;&nbsp;<span style="color:#dd6b66">2015-2018&nbsp;&nbsp;硕士&nbsp;&nbsp;生物信息学</span>',
	...
	var dataArr = ['瞎逛', '煲剧', '美食', '视频制作','阅读','瞎逛', '煲剧', '美食','视频制作', '阅读','瞎逛', '煲剧', '美食', '视频制作','阅读','瞎逛', '煲剧', '美食', '视频制作','阅读','瞎逛', '煲剧', '美食', '视频制作','阅读','瞎逛', '煲剧', '美食','视频制作', '阅读','瞎逛', '煲剧', '美食', '视频制作','阅读','瞎逛', '煲剧', '美食', '阅读','瞎逛', '煲剧', '美食', '视频制作','阅读',]
	var data = [];
